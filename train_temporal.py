...
from model.tem.UNETTem import UNETTem
...
def train(args):
    model = UNETTem(n_channels=3, n_classes=4, n_head=args.n_head)
...
def parse_args():
    ...
    parser.add_argument('--model_type', type=str, default='unet-temp',
